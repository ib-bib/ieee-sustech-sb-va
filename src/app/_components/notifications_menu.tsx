                ...
                <Dialog>
                  <DialogTrigger className="flex w-full items-center justify-center">
                    <div
                      ...
                      className={`w-5/6 cursor-pointer rounded-xl border p-2 text-center text-sm transition ${n.status === "u" ? "bg-blue-100 hover:bg-blue-200" : "bg-gray-50 hover:bg-gray-100"}`}
                    >
